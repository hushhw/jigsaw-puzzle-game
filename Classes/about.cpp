...
bool aboutScene::init()
{
	...
	auto spr_bg=Sprite::create("about2.png");//游戏的背景
	...
	bac1->setPosition(Point(visibleSize.width/2,visibleSize.height/4));
...
{
	Director::getInstance()->replaceScene(TransitionCrossFade::create(0.3,startScene::createscene()));	//切换到首界面
}
